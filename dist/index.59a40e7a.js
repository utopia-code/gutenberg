...
/* Laura López Doval */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _resizeSensorJs = require("css-element-queries/src/ResizeSensor.js");
...
if (bodyHasClassHome || bodyHasClassMuseum) new (0, _glideDefault.default)(".glide", {
    type: "slider",
    startAt: 0,
    autoplay: 4000
}).mount();
...
if (bodyHasClassBio) {
    ...
    new (0, _resizeSensorJsDefault.default)(element, function() {
        if (element.clientWidth >= 992) sidebar.forEach(function(s) {
            new (0, _stickySidebarJsDefault.default)(s, {
                topSpacing: 104,
                bottomSpacing: 0,
...
},{}],"cS4lK":[function(require,module,exports) {
/*!
 * Glide.js v3.6.0
